    ...
    <div class="py-4 dark:text-gray-400">
      ...
      <div class="w-full pt-8">
        ...
        <div class="relative px-6 py-3">
          <div class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 cursor-pointer" @click="defaultTextBodyVertical()">
        ...
        <div class="relative px-6 py-3">
          <div class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 cursor-pointer" @click="defaultTextFooterVertical()">
            <svg hidden="" class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
              <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
            </svg>
            <span class="ml-4">Вернуть шаблонный текст <span class="text-orange">контактов</span> ориентировки</span>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    defaultTextBodyVertical(){
      localStorage.removeItem('verticalBody');
      ...
      new EditorJS({
         ...
         */
        data: {
          blocks: self.$store.state.vertical.text.body
        },
        onReady: function(){
          //saveButton.click();
        },
        onChange: function() {
          /*editorjs_editor.save().then((outputData) => {
            localStorage.setItem('varticalBody', JSON.stringify(outputData.blocks));
          }).catch((error) => {
    ...
    defaultTextFooterVertical(){
      let self = this;

      localStorage.removeItem('verticalFooter');
      ...
      new EditorJS({
         ...
         */
        data: {
          blocks: self.$store.state.vertical.text.footer
        },
        onReady: function(){
          //saveButton.click();
        },
