<template>
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/horizontal">
        <icon name="dashboard" class="mr-2 w-4 h-4" :class="isUrl('horizontal') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('horizontal') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Horizontal</div> 
      </Link>
    </div>

    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/vertical">
        <icon name="dashboard" class="mr-2 w-4 h-4" :class="isUrl('vertical') ? 'fill-white' : 'fill-indigo-400 group-hover:fill-white'" />
        <div :class="isUrl('vertical') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Vertical</div> 
      </Link>
    </div>
