<template>
  <div class="overflow-y-auto bg-gray-50 w-full">
    <Head title="Вертикальная ориентация" />
    ...
    >
      <div class="flex items-center flex-row pt-3 py-4 z-10">
        ...
        >
          ...
          <div>Преобразовать в изображение формата *.PNG</div>
        </div>
    ...
    <div class="h-full">
      <div class="flex-center position-ref p-6" v-show="tab == 'editor'">
        <div id="form-vertical" class="form-orientation">
          <div class="level_1">
            ...
            >
              <div class="content flex flex-col justify-between">
                <div class="info flex flex-col justify-between w-full">
                  <div
                    class="wrapp_bodyeditor_photo flex flex-wrap justify-between w-full"
                  >
                    ...
                    <div class="col-2 p-0 pl-2 m-0 relative w-3/5">
                      <div class="editor">
                        <quill-editor
                          theme="bubble"
                          id="BodyEditor"
...
import VerticalLayout from "@/Shared/Vertical/Layout";
...
export default {
  ...
  mounted() {
    ...
    // if(!localStorage.vertical_body){
    //   localStorage.vertical_body = this.$store.getters.getVerticalBodyText
    // } else {
    //   this.$store.commit('changeVerticalBodyText', localStorage.vertical_body);
    // }

    // if(!localStorage.vertical_footer){
    //   localStorage.vertical_footer = this.$store.getters.getVerticalFooterText
    // } else {
    //   this.$store.commit('changeVerticalFooterText', localStorage.vertical_footer);
    // }
  },
  methods: {
    /* body */
    onBodyEditorReady(e) {
      if (!localStorage.vertical_body) {
        ...
        e.container.querySelector("#BodyEditor .ql-blank").innerHTML =
          localStorage.vertical_body;
        this.$store.commit(
          "changeVerticalBodyText",
          localStorage.vertical_body
        );
      }
    },
    ...
    onBodyEditorChange(e) {
      this.$store.commit("changeVerticalBodyText", e);
    } /* end */,
    ...
    onFooterEditorReady(e) {
      if (!localStorage.vertical_footer) {
        e.container.querySelector("#FooterEditor .ql-blank").innerHTML =
          localStorage.vertical_footer =
            this.$store.getters.getVerticalFooterText;
      } else {
        e.container.querySelector("#FooterEditor .ql-blank").innerHTML =
          localStorage.vertical_footer;
        this.$store.commit(
          "changeVerticalFooterText",
          localStorage.vertical_footer
        );
      }
    },
    ...
    onFooterEditorChange(e) {
      this.$store.commit("changeVerticalFooterText", e);
    } /* end */,
    ...
    converter() {
      ...
      htmlToImage
        .toPng(document.getElementById("form-vertical"))
...
#form-vertical .notification .item_3.mod_101 {
  /*человек*/
  font-size: 120px;
}
#form-vertical .notification .item_3.mod_102 {
  /*ребенок*/
  font-size: 90px;
}
#form-vertical .notification .item_3.mod_103 {
  /*подросток*/
  font-size: 85px;
}
#form-vertical .notification .item_3.mod_104 {
  /*подростков*/
  letter-spacing: 0.06em;
  font-size: 85px;
  line-height: 65px;
}
#form-vertical .notification .item_3.mod_105 {
  /*детей*/
  letter-spacing: 0.06em;
  font-size: 85px;
  line-height: 65px;
}
#form-vertical .notification .item_3.mod_106 {
  /*родственников*/
  letter-spacing: 0.01em;
  font-size: 72px;
}
#form-vertical .notification .item_3.mod_107 {
  /*людей*/
  letter-spacing: 0.06em;
  font-size: 85px;
  line-height: 65px;
